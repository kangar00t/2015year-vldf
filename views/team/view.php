    ...
    <div class="row g-infi">
        <div class="col-md-4">
            ...
            <? foreach ($model->turnirTeamsOne as $tteam) : ?>
                    <p class="tturnir-btn">
                        <span><?= $tteam->turnir->link; ?></span>
                        <a class="show_list" data-tteam="<?= $tteam->id; ?>">
                            состав >>
                        </a>
                    </p>
            <? endforeach; ?>
        ...
        <div class="col-md-8">
            <div class="tlist-block">
                ...
                Для просмотра заявочного листа команды на конкретный турнир нажмите кнопку "состав >>" напротив интересующего события в колонке слева.
