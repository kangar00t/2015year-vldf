    ...
    <? if ($game->yourTeam) : ?>
        ...
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6">
                ...
                <p>Командам предоставляется отметить варианты времени начала матча, как "Хотим", "можем" и "не можем".
                Вариантов "не можем" (вероятность, что команда будет поставлено на этот вариант близится к нулю) команда может выбрать только четыре, в противном случае вероятно отсутствие пересечений
                выбора с соперником. Приоритетно время будет поставлено на вариант "хотим", но только при наличии возможности. Как показывает практика, это бывает
