...
<div class="game-view">
    ...
    <div class="row g-infi">
                ...
                <div class="col-xs-3 col-sm-3 col-md-3">
                <p>Действия:</p>
                <? If (Yii::$app->user->id AND (Yii::$app->user->can('gameManager') OR (Yii::$app->user->identity->profileModel->isRefGame($model->id)))) : ?>
                    <p>
                ...
                <? endif; ?>
                    <p>
                        ...
                        <span class="glyphicon glyphicon-list-alt <?= $model->protocol ? "proto_yes" : "proto_no"; ?>" data-game="<?=$model->id;?>"></span>
                        <? endif; ?>
                    </p>
                </div>
